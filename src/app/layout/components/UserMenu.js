  ...
  return (
    <div>
      <IconButton
        ...
        color="inherit"
      >
        <Typography variant="caption">00205</Typography>
      </IconButton>
      <Menu
        id="menu-appbar"
        anchorEl={anchorEl}
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleClose}>เปลี่ยนรหัสผ่าน</MenuItem>
        <MenuItem onClick={swithMode}>{`${
          layoutReducer.darkMode ? "Light" : "Dark"
        } mode`}</MenuItem>
        <Divider light />
